...
let
  ...
  packages = {
    ...
    xnu             = applePackage "xnu"               "osx-10.13.3"     "0b8n643svc85n55hvnc2rayzpl8gdjarnfgpvwi8s9r6252savp2" {};
    hfs             = applePackage "hfs"               "osx-10.13.3"     "0xnrpgxq7awm250dybjd26ws5lxvynh4hzh2mdlv32f5vlkb0yrr" {};
